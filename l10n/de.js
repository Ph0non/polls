OC.L10N.register(
    ...
    "Answer all options on this day" : "Alle Optionen dieses Tages beantworten",
    "All Yes" : "Alle Ja",
    "All Maybe" : "Alle Vielleicht",
    "All No" : "Alle Nein",
    "Saving answers…" : "Antworten werden gespeichert…",
    "Answers saved for {date}." : "Antworten für {date} gespeichert.",
    "{date}: {saved} answers saved, {failed} not saved. Please check your answers." : "{date}: {saved} Antworten gespeichert, {failed} nicht gespeichert. Bitte prüfe deine Antworten.",
    ...
    "The used time zone is \"%s\". To view the times in your current time zone, enter the poll by clicking the button below." : "Die verwendete Zeitzone ist \"%s\". Um die Zeiten in deiner aktuellen Zeitzone anzuzeigen, öffne die Umfrage, indem du auf die Schaltfläche unten klickst.",
    ...
    "%s is the new owner of your poll." : "%s ist neuer Besitzer deiner Umfrage.",
    "{actor} transfered your poll \"%s\" to {newOwner}. You are no more the owner." : "{actor} hat deine Umfrage \"%s\" an {newOwner} übertragen. Du bist nicht mehr der Besitzer.",
    ...
    "This poll does not exist (anymore)." : "Diese Umfrage existiert nicht (mehr).",
    "No one." : "Niemand.",
    "Access denied" : "Zugriff verweigert",
    "You have no access to this poll. Contact %s if you think this is a mistake." : "Du hast keinen Zugang zu dieser Umfrage. Kontaktiere %s, wenn du glaubst, dass dies ein Fehler ist.",
    ...
    "You have reopened the poll \"{pollTitle}\"" : "Du hast die Umfrage \"{pollTitle}\" wiedereröffnet",
    ...
    "One or more orphaned votes heve been deleted from {pollTitle}" : "Eine oder mehrere verwaiste Stimmen wurden aus {pollTitle} gelöscht",
    "{actor} has deleted your orphaned polls from poll {pollTitle}" : "{actor} hat deine verwaisten Umfragen aus der Umfrage {pollTitle} gelöscht",
    "Orphaned votes deleted" : "Verwaiste Stimmen gelöscht",
    "{actor} deleted orphaned votes" : "{actor} hat verwaiste Stimmen gelöscht",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "Du hast die Umfrage {pollTitle} mit dem Team {sharee} geteilt",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor} hat die Umfrage {pollTitle} mit den Team {sharee} geteilt",
    "You have shared this poll with team {sharee}" : "Du hast diese Umfrage mit dem Team {sharee} geteilt",
    "{actor} has shared this poll with team {sharee}" : "{actor} hat diese Umfrage mit dem Team {sharee} geteilt",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "Du hast die Freigabe für das Team {sharee} der Umfrage {pollTitle} gelöscht",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "{actor} hat die Freigabe für das Team {sharee} der Umfrage {pollTitle} gelöscht",
    "You have deleted the share for team {sharee}" : "Du hast die Freigabe für das Team {sharee} gelöscht",
    "{actor} has deleted the share for team {sharee}" : "{actor} hat die Freigabe für das Team {sharee} gelöscht",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "Du hast die Freigabe für das Team {sharee} der Umfrage {pollTitle} wiederhergestellt",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "{actor} hat die Freigabe für das Team {sharee} der Umfrage {pollTitle} wiederhergestellt",
    "You have restored the share for team {sharee}" : "Du hast die Freigabe für das Team {sharee} wiederhergestellt",
    "{actor} has restored the share for team {sharee}" : "{actor} hat die Freigabe für das Team {sharee} wiederhergestellt",
    ...
    "Someone voted in a <strong>poll</strong>" : "Jemand hat bei einer <strong>Umfrage</strong> abgestimmt",
    "A polls app, similar to Doodle/DuD-Poll with the possibility to restrict access." : "Eine Umfragen-App ähnlich wie Doodle/DuD-Poll, mit der Möglichkeit Zugriffe zu beschränken.",
    ...
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduce your vote quota._" : ["%n verwaiste Stimme reduziert deine Stimmenquote.","%n verwaiste Stimmen reduzieren deine Stimmenquote."],
    ...
    "Select timezone to apply" : "Anzuwendende Zeitzone auswählen",
    "Use original timezone ({pollTimezone})" : "Die ursprüngliche Zeitzone verwenden ({pollTimezone})",
    "Use your timezone ({localTimezone})" : "Deine Zeitzone verwenden ({localTimezone})",
    ...
    "Allow download of poll results" : "Herunterladen der Umfrageergebnisse zulassen",
    ...
    "Anonymize poll irrevocably" : "Umfrage unwiderruflich anonymisieren",
    "Cancel" : "Abbrechen",
    "Ok" : "Ok",
    ...
    "Error restoring poll." : "Fehler beim Wiederherstellen der Umfrage.",
    "Error archiving poll." : "Fehler beim Archivieren der Umfrage.",
    ...
    "User preference" : "Benutzerpräferenz",
    ...
    "Use explicit \"No\" votes" : "Explizite \"Nein\"-Stimmen verwenden",
    ...
    "\"{pollTitle}\" has been added" : "\"{pollTitle}\" wurde hinzugefügt",
    "Choose a meaningful title for your poll" : "Einen aussagekräftigen Titel für die Umfrage auswählen",
    "Close" : "Schließen",
    "Yes" : "Ja",
    "No" : "Nein",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "Dadurch wird die Umfrage unwiderruflich gelöscht und {username} benachrichtigt.",
    "This will irreversibly delete the poll." : "Dadurch wird die Umfrage unwiderruflich gelöscht.",
    "OK" : "OK",
    ...
    "Transfered poll to {user}." : "Umfrage übertragen an {user}.",
    "Error transfering poll." : "Fehler beim Übertragen der Umfrage.",
    "Transfering a poll to another user may result in loss of access to this poll." : "Die Übertragung einer Umfrage an einen anderen Benutzer kann zum Verlust des Zugriffs auf diese Umfrage führen.",
    "Transfering a poll to {user} may result in loss of access to this poll." : "Die Übertragung einer Umfrage an {user} kann zum Verlust des Zugriffs auf diese Umfrage führen.",
    "You are not the owner of this poll. {owner} will get informed about this action." : "Du bist nicht der Besitzer dieser Umfrage. {owner} wird über diese Aktion informiert.",
    "You are not the owner of this poll. {owner} will get informed about the transfer to {newUser}." : "Du bist nicht der Besitzer dieser Umfrage. {owner} wird über die Übertragung an {newUser} informiert.",
    ...
    "Sort by answers of this option" : "Nach Antworten dieser Option sortieren",
    "Expand options" : "Optionen erweitern",
    "Available options" : "Verfügbare Optionen",
    "Option already exists" : "Option ist bereits vorhanden",
    "Error adding Option" : "Fehler beim Hinzufügen der Option",
    "Add a new date/time" : "Neues Datum/Uhrzeit hinzufügen",
    "Timezone" : "Zeitzone",
    "Duration" : "Dauer",
    "Duration time unit" : "Dauer Zeiteinheit",
    "Repetitions" : "Wiederholungen",
    "Add times" : "Zeiten hinzufügen",
    "All day" : "Ganztägig",
    ...
    "Submit" : "Übermitteln",
    "_%n repetition_::_Last of %n repetitions_" : ["%n Wiederholung","Letzte von %n Wiederholungen"],
    ...
    "Current timezone: {timezoneString}" : "Aktuelle Zeitzone: {timezoneString}",
    "Original timezone: {timezoneString}" : "Ursprüngliche Zeitzone: {timezoneString}",
    ...
    "Error updating poll group" : "Fehler beim Aktualisieren der Umfragegruppe",
    "Extended title" : "Erweiterter Titel",
    "Description" : "Beschreibung",
    "Expired {dateTime}" : "Abgelaufen {dateTime}",
    "Last activity {dateTime}" : "Letzte Aktivität {dateTime}",
    "No access" : "Kein Zugriff",
    "No access to this poll of {ownerName}." : "Kein Zugriff auf diese Umfrage von {ownerName}.",
    "Archived poll" : "Umfrage archiviert",
    ...
    "Open poll, accessible to all users of this instance and invited participants" : "Offene Umfrage, zugänglich für alle Benutzer dieser Instanz und eingeladene Teilnehmer",
    ...
    "You have been granted administrative rights" : "Dir wurden Administrationsrechte gewährt",
    "You participated" : "Du hast teilgenommen",
    "never" : "nie",
    "Poll owner: {ownerName}" : "Umfrage-Eigentümer: {ownerName}",
    "Take over poll?" : "Umfrage übernehmen?",
    "You will become the new owner and {username} will get notified." : "Du wirst der neue Besitzer und {username} wird benachrichtigt",
    "The poll group was deleted by removing the last member." : "Die Umfragegruppe wurde durch Entfernen des letzten Mitglieds gelöscht.",
    "Error removing poll from group." : "Fehler beim Entfernen der Umfrage aus der Gruppe.",
    "Error creating new poll group." : "Fehler beim Erstellen der neuen Umfragegruppe.",
    ...
    "Register to this poll" : "Für diese Umfrage registrieren",
    ...
    "Enable the automatic deletion of archived polls" : "Automatisches Löschen archivierter Umfragen aktivieren",
    "Days after which archived polls should be permanently deleted" : "Anzahl der Tage, nach denen archivierte Umfragen dauerhaft gelöscht werden sollen",
    ...
    "Sends out pending automatic reminders." : "Versendet ausstehende automatische Erinnerungen.",
    ...
    "{jobName} has been executed." : "{jobName} wurde ausgeführt.",
    "Start {jobName} manually." : "{jobName} manuell starten.",
    "{jobName} does not support manually run." : "{jobName} unterstützt keine manuelle Ausführung.",
    "Request Execution" : "Ausführung anfordern",
    "Request job execution" : "Job-Ausführung anfordern",
    ...
    "Use the default terms for public polls" : "Standardbedingungen für öffentliche Umfragen verwenden",
    "If you want to use different terms for public polls, enter them below." : "Wenn für öffentliche Umfragen andere Begriffe verwenden werden sollen, bitte diese unten eingeben.",
    ...
    "Anonymizing a poll of a restricted owner means that this poll is anonymous for everyone, including the owner." : "Die Anonymisierung einer Umfrage eines eingeschränkten Eigentümers bedeutet, dass diese Umfrage für alle, einschließlich des Eigentümers, anonym ist.",
    "Deleting and changing votes of participants is not possible" : "Das Löschen und Ändern von Teilnehmerstimmen ist nicht möglich",
    ...
    "Verbose poll list" : "Ausführliche Umfrageliste",
    "Check this for more poll information in the overview." : "Weitere Informationen zur Umfrage befinden sich in der Übersicht.",
    ...
    "Grant administrative poll access" : "Administrativen Zugriff auf die Umfrage gewähren",
    "Withdraw administrative poll access" : "Administrativen Zugriff auf die Umfrage zurücknehmen",
    ...
    "Error sending invitations" : "Fehler beim Senden der Einladungen",
    ...
    "Comments are disabled, except for owner and delegated poll administration." : "Kommentare sind für alle, außer dem Eigentümer und der delegierten Umfrageverwaltung deaktiviert.",
    "You have been granted administrative rights." : "Dir wurden Administrationsrechte gewährt.",
    ...
    "Forced display mode" : "Erzwungener Anzeigemodus",
    "Set default timezone for this poll" : "Standardzeitzone für diese Umfrage setzen",
    "Deletion and owner" : "Löschung und Besitzer",
    "As an admin you may edit this poll" : "Als Administrationsmitglied kannst du diese Umfrage bearbeiten",
    ...
    "Shares for a poll group grant voting access to the polls contained in the poll group." : "Durch die Freigabe einer Umfragegruppe wird der Abstimmungszugriff auf die in der Umfragegruppe enthaltenen Umfragen gewährt.",
    ...
    "Your timezone: ({timezone})" : "Deine Zeitzone: ({timezone})",
    "Poll timezone: ({timezone})" : "Umfrage-Zeitzone: ({timezone})",
    ...
    "Click to vote with {nextAnswer} for option {option}" : "Klicken, um mit {nextAnswer} für Option {option} abzustimmen",
    ...
    "Fetching polls…" : "Rufe Umfragen ab …",
    ...
    "Or [link]login[/link] if you are a member of this site." : "Oder [link]anmelden[/link], wenn du Mitglied dieser Seite bist.",
    ...
    "Loading poll…" : "Lade Umfrage …",
    "Fetching configuration…" : "Rufe Einstellungen ab …",
    "Collecting elements…" : "Sammle Elemente …",
    "This seems to be a huge poll, please be patient…" : "Dies scheint eine große Umfrage zu sein, bitte etwas Geduld …",
    ...
    "Error loading more participants" : "Fehler beim Laden weiterer Teilnehmer",
    ...
    "Poll updated" : "Umfrage aktualisiert",
    ...
    "Access" : "Zugriff",
    "Sort by access level" : "Nach Zugriffsebene sortieren",
    "Owner" : "Inhaber",
    "Sort by name of the owner" : "Nach dem Namen des Besitzers sortieren",
    "Expiration" : "Ablauf",
    "Sort by expiration date" : "Nach Ablaufdatum sortieren",
    "Sort by activity" : "Nach Aktivität sortieren",
    "Relevant" : "Relevant",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last activity, expiration or latest option (for date polls) are shown." : "Relevante Umfragen, die für dich relevant sind, weil du Teilnehmer, Veranstalter oder eingeladen wurdest. Angezeigt werden nur Umfragen, die nicht älter als 100 Tage sind (gemessen an Erstellung, letzter Aktivität, Ablaufdatum oder dem letzten Eintrag bei datumsbezogenen Umfragen).",
    "My polls" : "Meine Umfragen",
    "These are all polls where you are the owner." : "Dies sind alle Umfragen, deren Eigentümer du bist.",
    "Private polls" : "Private Umfragen",
    "All private polls, to which you have access." : "Alle privaten Umfragen, zu denen du Zugriff hast",
    "Participated" : "Teilgenommen",
    "All polls in which you participated." : "Alle Umfragen, an denen du teilgenommen hast.",
    "Openly accessible polls" : "Öffentlich zugängliche Umfragen",
    "A complete list with all openly accessible polls on this site." : "Vollständige Liste aller frei zugänglichen Umfragen auf dieser Seite.",
    ...
    "You can delete, archive and take over polls in this list, but access is still not possible." : "In dieser Liste kannst Du Umfragen löschen, archivieren und übernehmen, ein Zugriff ist jedoch weiterhin nicht möglich."
},
